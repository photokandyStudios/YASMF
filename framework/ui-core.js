...
PKUI.CORE.pushView = function(theView)
{
  ...
  if (PKUI.CORE.consoleLogging)
  {
    console.log("... Called viewWillHide on hiding View");
  }
  ...
  if (PKUI.CORE.consoleLogging)
  {
    console.log("... Called viewWillAppear on showing View");
  }
  ...
  PKUTIL.delay(100, function()
  {
    ...
    PKUTIL.delay(261, function()
    {
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Pushed view on stack");
      }
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Called viewDidHide on hidden View");
      }
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Called viewDidAppear on shown View");
      }
    });
  });
}
...
PKUI.CORE.popView = function()
{
  ...
  if (PKUI.CORE.consoleLogging)
  {
    console.log("... There are views top pop");
  }
  ...
  PKUTIL.delay(100, function()
  {
    ...
    PKUTIL.delay(261, function()
    {
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Set display none to the hiding element");
      }
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Current view is showing view");
      }
      PKUI.CORE.currentView = theViewShowing;
      if (PKUI.CORE.consoleLogging)
      {
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Called viewDidHide");
      }
      if (theViewShowing.viewDidAppear)
      {
        theViewShowing.viewDidAppear();
      ...
      if (PKUI.CORE.consoleLogging)
      {
        console.log("... Called viewDidAppear");
      }
    });
  });
}
